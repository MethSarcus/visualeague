...
const LineupPieChart = (props: MyProps) => {
    ...
    const formatScoresForPieChart = (players: MatchupPlayer[]) => {
            ...
            return players.map((player, index) => {
                let fullName: any = player && player.playerId && player.playerId != "0" || "Empty"
                if (props.playerDetails != undefined && fullName != "Empty") {
                    fullName = `${props.playerDetails!!.get(player.playerId!!)!!.first_name} ${props.playerDetails!!.get(player.playerId!!)!!.last_name}`
                }
                return {
                    id: fullName,
                    label: fullName,
